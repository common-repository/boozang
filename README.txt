...
1. The full view of the Boozang tool.
2. The quick-panel for the basic testing operations record, validate, annotate and form fill.
3. The tool in action testing a Woo-commerce application.
